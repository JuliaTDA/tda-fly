...
- **Quantiles (10%, 25%, 50%, 75%, 90%)**: Distribution of persistence values, capturing the range of feature sizes
...
stat_names = ["count", "max_pers", "total_pers", "q10", "q25", "median_pers", "q75", "q90", "entropy"]
...
stats_df = DataFrame(
    ...
    q10 = stats_matrix[:, 4],
    q25 = stats_matrix[:, 5],
    median_pers = stats_matrix[:, 6],
    q75 = stats_matrix[:, 7],
    q90 = stats_matrix[:, 8],
    entropy = stats_matrix[:, 9]
)
...
p4 = boxplot(stats_df.family, stats_df.q10,
             title="Q10 Persistence", legend=false, ylabel="persistence")
p5 = boxplot(stats_df.family, stats_df.q25,
             title="Q25 Persistence", legend=false, ylabel="persistence")
p6 = boxplot(stats_df.family, stats_df.median_pers,
             title="Median Persistence", legend=false, ylabel="persistence")
p7 = boxplot(stats_df.family, stats_df.q75,
             title="Q75 Persistence", legend=false, ylabel="persistence")
p8 = boxplot(stats_df.family, stats_df.q90,
             title="Q90 Persistence", legend=false, ylabel="persistence")
plot(p1, p2, p3, p4, p5, p6, p7, p8, layout=(2, 4), size=(1200, 600))
```
